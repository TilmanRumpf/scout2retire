...
export const COLUMN_SETS = {
  ...
  climate: 'id, name, summer_climate_actual, winter_climate_actual, sunshine_level_actual, precipitation_level_actual, seasonal_variation_actual, humidity_level_actual, geographic_features_actual, vegetation_type_actual, environmental_factors',

  // Cost - Financial information
  cost: 'id, name, cost_of_living_usd, cost_index, rent_1bed, rent_2bed_usd, healthcare_cost_monthly, groceries_cost, utilities_cost',

  // Lifestyle - Community and activities
  lifestyle: 'id, name, pace_of_life_actual, social_atmosphere, retirement_community_presence, expat_community_size, cultural_events_frequency, lgbtq_friendly_rating, pet_friendly_rating, traditional_progressive_lean',

  // Infrastructure - Services and connectivity
  infrastructure: 'id, name, walkability, public_transport_quality, nearest_major_hospital_km, airport_distance, english_speaking_doctors, emergency_services_quality, local_mobility_options, regional_connectivity, international_access',

  // Admin - Visa and residency
  admin: 'id, name, country, visa_requirements, residency_path_info, retirement_visa_available, digital_nomad_visa, easy_residency_countries',
...
export const COMMON_QUERIES = {
  ...
  comparison: 'id, name, country, quality_of_life, healthcare_score, cost_index, cost_of_living_usd, summer_climate_actual, pace_of_life_actual, walkability, retirement_visa_available'
}
