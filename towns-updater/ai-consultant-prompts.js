...
export const PROMPT_TEMPLATES = {
  description: (town) => `
    As a retirement consultant who has lived in ${town.name}, ${town.country}, 
  ...
  lifestyle_description: (town) => `
    Based on your experience living in ${town.name}, describe the lifestyle 
