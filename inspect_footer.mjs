...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: './footer_page_screenshot.png', fullPage: true });
    console.log('Screenshot saved to ./footer_page_screenshot.png');
    ...
    if (await hamburgerButton.count() > 0) {
      ...
      await page.screenshot({ path: './footer_menu_screenshot.png', fullPage: true });
      console.log('Menu screenshot saved to ./footer_menu_screenshot.png');
    }
