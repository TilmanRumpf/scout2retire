...
-- =============================================================================
-- Problem: Device tracking was working in October tracking Shabnam in Nova Scotia
-- Today someone dropped the full function and created a simplified one
-- This restores the COMPLETE function with all 40+ parameters
-- Date: 2025-11-06
-- =============================================================================

BEGIN;

-- Drop the broken simplified version
DROP FUNCTION IF EXISTS public.update_user_device CASCADE;

-- Restore the FULL function that was working in October
